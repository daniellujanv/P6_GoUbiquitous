...
import com.example.android.sunshine.app.wearable.ListenerService;
import com.example.android.sunshine.app.wearable.SendMessageWearable;
...
public class MainActivity extends AppCompatActivity
    ...
    public static final String PROPERTY_REG_ID = "perceptive-lamp-111822";
     ...
     */
    static final String PROJECT_NUMBER = "1082591399214";
...
//        mPeerId = getIntent().getStringExtra(WatchFaceCompanion.EXTRA_PEER_ID);
    ...
    public void updateWearable(){
        /**
         * Received callback for data changed in cursor
         * update wearable weather
         * This should not be called only when cursor loads new data
         * but for the purposes of the exercise should be enough...
         */
        new SendMessageWearable(getApplicationContext(), mGoogleApiClient).execute();
    }
    ...
    public void onConnected(Bundle bundle) {
        Log.i(LOG_TAG, "connected GoogleApiClient...");
        Wearable.MessageApi.addListener(mGoogleApiClient, this);
        Wearable.MessageApi.addListener(mGoogleApiClient
                , new ListenerService());
//        new SendMessageWearable().execute("TESTING");
    }
    ...
    public void onMessageReceived(MessageEvent messageEvent) {
        ...
        if (messageEvent.getPath().equalsIgnoreCase(VOICE_TRANSCRIPTION_MESSAGE_PATH)) {
            ...
            if(message.equals(UPDATE_WEARABLE_PLEASE)){
                updateWearable();
            }else{
                Log.d(LOG_TAG, "Received unknown message :: "+message);
            }
    ...
    public void onConnectionFailed(ConnectionResult connectionResult) {
        Log.i(LOG_TAG, "connection failed GoogleApiClient... " + connectionResult.toString());
    }
}
